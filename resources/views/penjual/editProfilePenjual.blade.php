        ...
        <form class="flex flex-col mr-14" action="/profilePenjual/prosesEdit" method="post">
            ...
            <div class="p-4 border shadow-md rounded-md flex flex-col w-[540px] mb-6">
                <div>
                    ...
                    <input class="bg-white p-2 drop-shadow-md w-60 text-sm border border-slate-300 rounded-md outline-[#B2A4FF]" value="{{$toko->nama_toko}}" type="text" name="nama_toko">
                    @error('nama_toko')
                        <div class="mt-2 text-sm text-red-600">{{$message}}</div>
                    @enderror
                </div>
                <div>
                    ...
                    <input class="bg-white p-2 drop-shadow-md w-60 text-sm border border-slate-300 rounded-md outline-[#B2A4FF]" value="{{$toko->alamat_toko}}" type="text" name="alamat_toko">
                    @error('alamat_toko')
                        <div class="mt-2 text-sm text-red-600">{{$message}}</div>
                    @enderror
                </div>
                <div>
                    ...
                    <textarea class="bg-white p-2 drop-shadow-md w-60 text-sm border border-slate-300 rounded-md outline-[#B2A4FF]" name="deskripsi_toko">{{$toko->deskripsi_toko}}</textarea>
            ...
            <div class="flex flex-row mb-4">
                ...
                <a class="bg-[#E68686] p-2 rounded-md hover:bg-[#F2C4C4] duration-200 drop-shadow-md" href="/profilePenjual">Batal</a>
            </div>
        </form>
    </div>
@endsection