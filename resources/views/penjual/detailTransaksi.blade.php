...
@section('content')
    <div class="pl-64 pt-28 flex">
        <form class="flex flex-row mx-auto" action="{{url('/konfirmasiTransaksi/'.$transaksi->id)}}" method="post" onsubmit="return confirm('Konfirmasi Pesanan Ini?')" enctype="multipart/form-data">
            @csrf
            <input type="hidden" value="{{$transaksi->id}}" name="id">
            <input type="hidden" value="{{$transaksi->barang['id']}}" name="barang_id">
            <div class="flex flex-col">
                <div class="bg-[#F2C4C4] w-[200px] h-[200px] rounded-lg m-4 drop-shadow-lg">
            ...
            <div class="flex p-4 border shadow-md rounded-md">
                <div class="">
                    ...
                    <div>
                        <button class="bg-[#E68686] mr-2 p-2 rounded-md hover:bg-[#F2C4C4] duration-200 drop-shadow-lg">Konfirmasi</button>
                        <a class="bg-[#E68686] p-2 rounded-md hover:bg-[#F2C4C4] duration-200 drop-shadow-lg" href="/dashboardPenjual/pengiriman">Kembali</a>
                    </div>
                </div>
                <div class="">
