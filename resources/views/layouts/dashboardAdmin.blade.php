...
<body class="">
    ...
    <div class="z-[2] fixed bg-[#E68686] h-[100vh] w-[250px] flex flex-col items-center">
        <a class="bg-[#F2C4C4] rounded-lg py-4 px-14 mt-5 drop-shadow-lg font-bold" href="/dashboardAdmin">Dashboard</a>
        <ul class="">
            <li class="my-5">
                <a class="hover:bg-[#F2C4C4] duration-200 py-4 text-start pl-14 w-[210px] block rounded-lg drop-shadow-lg" href="/dashboardAdmin/transaksi">Verifikasi</a>
            </li>
            <li class="my-5">
                <a class="hover:bg-[#F2C4C4] duration-200 py-4 text-start pl-14 w-[210px] block rounded-lg drop-shadow-lg" href="/dashboardAdmin/pembayaran">Pembayaran</a>
            </li>
            <li class="my-5">
                <a class="hover:bg-[#F2C4C4] duration-200 py-4 text-start pl-14 w-[210px] block rounded-lg drop-shadow-lg" href="/dashboardAdmin/riwayat">Riwayat</a>
            </li>
        </ul>
    </div>
