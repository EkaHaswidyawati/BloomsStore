...
@section('content')
    <div class="pl-72 pt-32">
        <form class="flex flex-col mr-14" action="/profileAdmin/prosesEdit" method="post">
            @csrf
            ...
            <div class="p-4 border shadow-md rounded-md flex flex-col w-[540px] mb-6">
                ...
                <div class="flex flex-row mt-4">
                    ...
                    <a class="bg-[#E68686] p-2 rounded-md hover:bg-[#F2C4C4] duration-200 drop-shadow-md" href="/profileAdmin">Batal</a>
                </div>
            </div>
        </form>
    </div>
