    ...
    <div class="pl-64 pt-28 flex">
        <form class="flex flex-row mx-auto" action="{{url('/dashboardAdmin/transaksi/simpan')}}" method="post" onsubmit="return confirm('Note: Pastikan nominal transfer sudah benar')" enctype="multipart/form-data">
            ...
            <div class="flex flex-col">
                <div class="bg-[#E68686] w-[200px] h-[200px] rounded-lg m-4 drop-shadow-lg">
            ...
            <div class="flex p-4 border shadow-md rounded-md">
                <div class="">
                    ...
                    <div>
                        <button class="bg-[#E68686] mr-4 p-2 rounded-md hover:bg-[#F2C4C4] duration-200 drop-shadow-lg" type="submit">Simpan</button>
                        <a class="bg-[#E68686] p-2 rounded-md hover:bg-[#F2C4C4] duration-200 drop-shadow-lg" href="/dashboardAdmin/transaksi">Kembali</a>
                    </div>
                </div>
                <div class="">
