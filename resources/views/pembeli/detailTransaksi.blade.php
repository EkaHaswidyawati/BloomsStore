        ...
        @csrf
            ...
            <div class="flex p-4 border shadow-md rounded-md">
                <div class="mr-16">
                    ...
                    <div>
                        <button class="bg-[#E68686] mt-2 mr-4 p-2 rounded-md hover:bg-[#F2C4C4] duration-200 drop-shadow-lg" type="submit">Bayar</button>
                        <a class="bg-[#E68686] mt-2 p-2 rounded-md hover:bg-[#F2C4C4] duration-200 drop-shadow-lg" href="/transaksi">Kembali</a>
                    </div>
                </div>
                <div class="mr-16">
